...
<body>
	...
	<div id="scedule" style="padding: 30px 0 0 0">
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
               ...
               <div class="input-group">
                 ...
                 <input type="hidden" id="course" name="course_id" value=""""),_display_(Seq[Any](/*283.76*/course/*283.82*/.id)),format.raw/*283.85*/("""" > 
                  <!--
		...
		<form action=""""),_display_(Seq[Any](/*310.18*/routes/*310.24*/.StudentOperationController.rateCourse(course.id))),format.raw/*310.73*/("""">
					...
					<table>
						<tr>
							<td><div style="float: left; width: 300px">Fairness
									and help:</div></td>
							<td><input id="input-1" name="fair" value=""""),_display_(Seq[Any](/*319.52*/ranking/*319.59*/.fair)),format.raw/*319.64*/(""""
				...
				<table>
					<tr>
						...
						<td><input id="input-3" name="material"
							value=""""),_display_(Seq[Any](/*333.16*/ranking/*333.23*/.material)),format.raw/*333.32*/("""" class="rating" data-min="0"
			...
			<div style="width: 100%; height: 30px">
				<table>
					<tr>
						...
						<td><input id="input-4" name="fun" value=""""),_display_(Seq[Any](/*344.50*/ranking/*344.57*/.fun)),format.raw/*344.61*/(""""
							class="rating" data-min="0" data-max="5" data-step="0.5"
							data-size="xs"></td>
					</tr>
				</table>
				...
				<table>
					<tr>
						<td><div style="float: left; width: 300px">grade and
								effort:</div></td>
						<td><input id="input-2" name="grade" value=""""),_display_(Seq[Any](/*356.52*/ranking/*356.59*/.grade)),format.raw/*356.65*/(""""
							class="rating" data-min="0" data-max="5" data-step="0.5"
							data-size="xs"></td>
					</tr>
				</table>
				...
				<table>
					<tr>
						...
						<td><input id="input-2" name="recommend"
							value=""""),_display_(Seq[Any](/*368.16*/ranking/*368.23*/.recommend)),format.raw/*368.33*/("""" class="rating" data-min="0"
							data-max="5" data-step="0.5" data-size="xs"></td>
					</tr>
				</table>
			</div>
			...
			<div style="width: 100%; height: 30px">
				<p class="text-title">Overall Rate: """),_display_(Seq[Any](/*377.42*/ranking/*377.49*/.overall_rate)),format.raw/*377.62*/("""</p>
			</div>
		...
		<form method="get" action=""""),_display_(Seq[Any](/*385.31*/routes/*385.37*/.StudentOperationController.saveComment(course.id))),format.raw/*385.87*/("""" id="commentForm">
	<div  style="padding: 50px 0 0 0">
		<p class="coursesubtitle">Comments
		<p>
		<div class="panel panel-default">
			<ul class="list-group" id="comments">
			"""),_display_(Seq[Any](/*391.5*/for(comment <- comments) yield /*391.29*/{_display_(Seq[Any](format.raw/*391.30*/("""
				<li class="list-group-item"><p>("""),_display_(Seq[Any](/*392.38*/comment/*392.45*/.student_id)),format.raw/*392.56*/(""")</p>"""),_display_(Seq[Any](/*392.62*/comment/*392.69*/.comment)),format.raw/*392.77*/(""" </li>
			""")))})),format.raw/*393.5*/("""
			</ul>
