...
// @DATE:Thu Jul 02 15:15:06 CEST 2015
...
// @LINE:38
private[this] lazy val controllers_StudentOperationController_addJobToFavorites23 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("coursematch/student/dashboard/addJobToFavorites/"),DynamicPart("id", """[^/]+""",true))))
        

// @LINE:39
private[this] lazy val controllers_StudentOperationController_removeJobFromFavorites24 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("coursematch/student/dashboard/removeJobFromFavorites/"),DynamicPart("id", """[^/]+""",true))))
...
// @LINE:38
case controllers_StudentOperationController_addJobToFavorites23(params) => {
   call(params.fromPath[Long]("id", None)) { (id) =>
        invokeHandler(controllers.StudentOperationController.addJobToFavorites(id), HandlerDef(this, "controllers.StudentOperationController", "addJobToFavorites", Seq(classOf[Long]),"GET", """""", Routes.prefix + """coursematch/student/dashboard/addJobToFavorites/$id<[^/]+>"""))
   }
}
        

// @LINE:39
case controllers_StudentOperationController_removeJobFromFavorites24(params) => {
   call(params.fromPath[Long]("id", None)) { (id) =>
        invokeHandler(controllers.StudentOperationController.removeJobFromFavorites(id), HandlerDef(this, "controllers.StudentOperationController", "removeJobFromFavorites", Seq(classOf[Long]),"GET", """""", Routes.prefix + """coursematch/student/dashboard/removeJobFromFavorites/$id<[^/]+>"""))
   }
}
