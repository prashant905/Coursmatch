// @SOURCE:C:/Users/PRASHANT/workspace/forms/conf/routes
// @HASH:8990fdc834af707cf53c224b4088cc949dfa0c80
// @DATE:Fri Jun 05 19:02:02 CEST 2015
...
// @LINE:9
private[this] lazy val controllers_Application_index1 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("signIn"))))
...
case controllers_Application_index1(params) => {
   call { 
        invokeHandler(controllers.Application.index(), HandlerDef(this, "controllers.Application", "index", Nil,"GET", """ SignIn""", Routes.prefix + """signIn"""))
   }
}
