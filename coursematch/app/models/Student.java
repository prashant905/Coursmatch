...
public class Student {
  ...
  public String toString() {
    return String.format("[Student name: '%s' Password: %s Grade Level: %s GPA: %s Majors: %s]", this.getName(),
        this.getPassword(),  this.level, this.gpa, this.getMajors());
  }
  ...
  public static StudentFormData makeStudentFormData(long id) {
    for (Student student : allStudents) {
      if (student.getId() == id) {
        return new StudentFormData(student.name, student.password, student.level, student.gpa,student.majors);
      }
    }
